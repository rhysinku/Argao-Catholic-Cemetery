...
if(isset($_GET['accdelete'])) //account Delete
{
    $id = $_GET['accdelete'];
   ...
   // $querydelete = mysqli_query($conn, "DELETE FROM user WHERE id_user=$id");
    ...
    if (mysqli_query($conn,$del)) {
        header ("location: ../../Users.php?msg=deletesuc");
    }
    else{
        header ("location: ../../Users.php?msg=NOdelete");
    }
...
if(isset($_GET['bookCdelete']))
{
    ...
    if (mysqli_query($conn,$del)) {
        header ("location: ../../Transaction.php?msg=deletesuc");
    }
    else{
        header ("location: ../../index.php?msg=NOdelete");
    }
}
